 ...
 */
export const NoticeIntegrated: React.FC<NoticeSkinProps> = ({ 
    data = {}, 
    actions = {}, 
    options = {} 
}) => {
    ...
    const {
        handleNoticeClick = (notice: Notice) => {
    ...
    // 리스트 아이템 애니메이션
    useEffect(() => {
        if (animation && view === 'list' && isAnimated && currentNotices.length > 0) {
    ...
    }, [animation, animationDuration, view, currentNotices, isAnimated]);
                        ...
                        if (currentPage > 1) {
                            pages.push(
                                <button
                                    ...
                                    className="notice-skin-pagination-btn"
                                >
                                    이전
                                </button>
                            );
                        ...
                        for (let i = startPage; i <= endPage; i++) {
                            pages.push(
                                <button
                                    ...
                                    className={`notice-skin-pagination-btn ${currentPage === i ? 'notice-skin-pagination-active' : ''}`}
                                >
                                    {i}
                                </button>
                            );
